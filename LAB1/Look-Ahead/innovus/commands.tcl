...
#  Created on Thu Oct 21 19:24:29 2021                
#                                                     
#######################################################
...
set init_top_cell IIR_filter_LA
set init_verilog ../netlist/IIR_filter_LA.v
...
placeDesign
gui_select -rect {24.985 -12.237 2.122 -20.323}
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix IIR_filter_LA_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix IIR_filter_LA_postRoute -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile IIR_filter_LA.gateCount
saveNetlist IIR_filter_LA.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network IIR_filter_LA.sdf
#exit
