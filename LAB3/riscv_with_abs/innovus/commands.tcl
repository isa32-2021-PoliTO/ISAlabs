...
set init_verilog ../netlist/${init_top_cell}.v
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix ${init_top_cell}_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix ${init_top_cell}_postRoute -outDir timingReports
